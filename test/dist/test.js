...
var iterNegaFibonacciSeq = require( './../../dist' );
...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof iterNegaFibonacciSeq, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'if an environment supports `Symbol.iterator`, the returned iterator is iterable', function test( t ) {
	var iterNegaFibonacciSeq;
	var it1;
	var it2;
	var i;

	iterNegaFibonacciSeq = proxyquire( './../dist/main.js', {
		'@stdlib/symbol-iterator': '__ITERATOR_SYMBOL__'
	});

	it1 = iterNegaFibonacciSeq();
